  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-primary">
            <div class="box-body">
              {!! Form::open(['url'=>Request::url().'/'.$DataUser->id_user,'files'=>true,'class'=>'register-form', 'method' => 'POST', 'class' => 'form-horizontal', 'role' => 'form']) !!}

              <div class="row">
                <div class="col-sm-2">
                  <img src="/image/dosen/{{$DataUser->foto}}" class="img-thumbnail">
                </div>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input class="form-control" type="text" name="nidn" value="{{$DataUser->NIDN}}" required pattern="[0-9]{5,}" title="Input NIDN Tanpa Titik">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input class="form-control" type="text" name="nama" value="{{$DataUser->nama}}" required pattern="[a-zA-Z.,].{3,}" title="Input Nama Sesuai Absen">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input class="form-control" type="text" name="nohp" value="{{$DataUser->no_hp}}" required pattern="[0][0-9]{11,15}" title="Input Nomor HP diawali dengan 0">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input class="form-control" type="email" name="email" value="{{$DataUser->email}}" required>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input class="form-control" type="text" name="username" value="{{$Auth->username}}" pattern=".{6,}" title="Minimal 6 Karakter">
              </div>
            </div>
