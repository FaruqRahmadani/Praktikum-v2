...
<div class="login-box">
  <div class="login-logo">
    <a href="{{ url()->current() }}"><b>Daftar Mahasiswa</b><br>Praktikum UNISKA</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <div class="alert alert-info alert-dismissible">
      ...
      <h4><i class="icon fa fa-info"></i> Daftar Mahasiswa</h4>
      Ini Merupakan Halaman Daftar Bagi Mahasiswa
    </div>
    ...
    <form action="{{ route('register') }}" method="post">
      {{ csrf_field() }}
      <input name="tipe" type="hidden" class="form-control" placeholder="tipe" value="2" readonly>

      <div class="form-group has-feedback">
        <input name="NPM" value="{{old('NPM')}}" type="text" class="form-control" placeholder="NPM" autofocus required title="Input NPM Tanpa Titik" pattern="[0-9]{8,8}">
      ...
      <div class="row">
        <div class="col-xs-12" style="margin-bottom: 10px;">
          <button type="submit" class="btn btn-primary btn-block btn-flat"><b>Daftar Sebagai Mahasiswa</b></button>
        </div>
      </div>
      </form>
      <div class="row">
