    ...
    <section class="content">
      ...
      <div class="box box-primary">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input class="form-control" type="text" name="NPM" value="{{ $Mahasiswa->NPM }}" required pattern="[0-9]{8,8}" title="Input NPM Tanpa Titik">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input class="form-control" type="text" name="nama" value="{{ $Mahasiswa->nama }}" required pattern="[a-zA-Z0-9]+.{3,}" title="Minimal 4 Karakter">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input class="form-control" type="text" name="NomorHP" value="{{ $Mahasiswa->no_hp }}" required pattern="[0][0-9]{11,15}" title="Input Nomor HP diawali dengan 0">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input class="form-control" type="email" name="email" value="{{ $Mahasiswa->email }}" required>
              </div>
            </div>
