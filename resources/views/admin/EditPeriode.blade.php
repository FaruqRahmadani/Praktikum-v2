    ...
    <section class="content">
      ...
      <div class="box box-primary">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input class="form-control" type="text" name="NamaPeriode" value="{{$Periode->periode}}" required pattern="[a-zA-Z0-9/]+.{3,}" title="Minimal 4 Karakter">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input class="form-control" type="date" name="TanggalTutup" value="{{Carbon\Carbon::parse($Periode->tanggal_tutup)->format('Y-m-d')}}" required min="{{Carbon\Carbon::now()->format('Y-m-d')}}">
              </div>
            </div>
